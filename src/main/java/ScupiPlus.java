...
public class ScupiPlus {
    ...
    public static void main(String[] args) {
        ...
        try{
            ...
            if (line.hasOption("help")){
                ...
                helpFormatter.printHelp("ScupiPlus", options);
                return;
            }
    ...
    static public void start(AbstractStores stores, String creditsPath, String keywordsPath, String movieMetadataPath, String ratingsPath, Integer numMovies) {
        ...
        DisplayImage logo;
        try {
            logo = new DisplayImage("src/main/resources/img/ScupiPlusLogo.png");
